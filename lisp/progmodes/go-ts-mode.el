...
(defvar go-ts-mode--indent-rules
  `((go
     ...
     ((parent-is "special_argument_list") parent-bol go-ts-indent-offset)
     ((parent-is "type_arguments") parent-bol go-ts-indent-offset)
     ((parent-is "type_case") parent-bol go-ts-indent-offset)
     ((parent-is "type_declaration") parent-bol go-ts-indent-offset)
     ((parent-is "type_instantiation_expression") parent-bol go-ts-indent-offset)
